<x-layouts.app :title="'About'" :description="'iReka Soft Enterprise — founded 2015 in Cyberjaya, Malaysia. The studio behind the Orderla commerce suite.'">

  <x-page-hero :image="asset('images/heroes/about.jpg')">
    <div class="grid gap-10 md:grid-cols-[1fr_auto] md:items-end">
      ...
      <img src="{{ asset('images/about/Artboard-17-300x300.png') }}" alt="iReka Soft"
        class="w-20 h-20 rounded-2xl shadow-lg shadow-black/30" width="60" height="60" loading="eager">
    </div>
  </x-page-hero>
  ...
  <section class="bg-ink-soft text-paper">
    <div class="mx-auto max-w-6xl px-6 pb-8 pt-8 grid gap-12 md:grid-cols-2 md:items-center">
      <div>
        <p class="font-mono text-[12px] uppercase tracking-wide text-gold mb-3 flex items-center gap-2">
          <i class="bi bi-lightbulb text-base" aria-hidden="true"></i>
      ...
      <div>
        <p class="font-mono text-[12px] uppercase tracking-wide text-gold mb-3 flex items-center gap-2">
          <i class="bi bi-apple text-base" aria-hidden="true"></i>
          <i class="bi bi-google text-base" aria-hidden="true"></i>
          Platform partners
        </p>
        <p class="text-paper/70 leading-relaxed">
  ...
  <section class="bg-ink text-paper">
    <div class="mx-auto max-w-6xl px-6 pb-8 pt-8 grid gap-10 md:grid-cols-2">
      <div>
        <p class="font-mono text-[12px] uppercase tracking-wide text-gold mb-3 flex items-center gap-2">
      ...
      <div>
        <p class="font-mono text-[12px] uppercase tracking-wide text-gold mb-3 flex items-center gap-2">
          <i class="bi bi-flag text-base" aria-hidden="true"></i>
          Mission
        </p>
        <p class="text-paper/70 leading-relaxed">
      ...
      <div>
        <p class="font-mono text-[12px] uppercase tracking-wide text-gold mb-3 flex items-center gap-2">
          <i class="bi bi-bullseye text-base" aria-hidden="true"></i>
          Objective
        </p>
        <p class="text-paper/70 leading-relaxed">
      ...
      <div>
        <p class="font-mono text-[12px] uppercase tracking-wide text-gold mb-3 flex items-center gap-2">
          <i class="bi bi-heart text-base" aria-hidden="true"></i>
          Values
        </p>
        <p class="text-paper/70 leading-relaxed">
  ...
  <section class="bg-paper">
    <div class="mx-auto max-w-6xl px-6 py-16 md:py-20">
      ...
      <dl class="grid gap-6 md:grid-cols-3 text-sm">
        <div>
        ...
        <div>
          ...
          <dd class="font-display text-lg">201503132920 <br>
            <span class="text-charcoal/50 font-mono tracking-wide text-sm">              
              002435676-P
            </span>
        </div>
        <div>
        ...
        <div>
          ...
          <dd class="font-display text-lg">
            <a href="{{ route('about.hijazi') }}" class="text-terracotta hover:underline transition-colors">
              Muhammad Hijazi
            </a>
          </dd>
        </div>
